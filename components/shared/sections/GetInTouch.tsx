...
import Lightning from "@components/home/sections/Lightning";

const GetInTouch = () => {
  return (
    <section className="w-full bg-white-900 px-[24px] py-[48px] dark:bg-black-200 md:px-[30px] md:py-[72px]">
      <div className="relative mx-auto w-full max-w-[1270px] px-[18px] py-[78px] md:px-[36px] md:py-[56px] lg:px-[70px] lg:py-[82px] border border-black rounded-[20px]">
  ...
  />
        ...
        <div className="relative z-10 flex h-full w-full flex-col items-end justify-between md:flex-row">
          <Typography
            as="h2"
            className="w-full pb-6 !text-left text-[30px] !font-bold leading-[31px] text-white md:pb-0 md:text-[44px] md:leading-[50px] lg:text-[48px] lg:leading-[55px]"
          >
          ...
          <Link
            href="/contact"
            className="flex h-[47px] w-full justify-end md:h-auto hover:cursor-pointer"
          >
            <Button className="bottom-0 h-[47px] w-full rounded-full bg-primary-light px-2 py-[14px] hover:bg-primary-light/90 md:h-[69px] md:w-[310px] md:max-w-[323px] md:px-3 md:py-5 hover:cursor-pointer">
