  ...
  return (
    ...
    >
      <div className="relative mx-auto flex w-full max-w-[740px] flex-col items-center justify-center py-[48px] md:py-0 md:pb-[108px]">
        <Typography
          as="h1"
          className="highlighted-text mb-5 text-center text-[42px] !font-bold leading-[48px] tracking-[-0.64px] text-black-200 dark:text-white-900 md:mb-[28px] md:text-[64px] md:leading-[83px]"
        >
          Get in Touch
        </Typography>
