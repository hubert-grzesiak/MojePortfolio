...
const ContactPrompt = () => {
  ...
  return (
    <>
      <button
        type="button"
        className="group liquid-glass mx-auto mt-10 flex min-h-16 w-full max-w-[576px] items-center gap-3 rounded-full py-2 pl-6 pr-2 text-left transition-colors hover:bg-white/[0.05] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
        onClick={() => setOpen(true)}
        onFocus={openFromFocus}
      >
        <span className="min-w-0 flex-1 text-[15px] leading-5 text-white/45 sm:text-[16px]">
