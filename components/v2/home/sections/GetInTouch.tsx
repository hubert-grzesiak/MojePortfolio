...
const GetInTouch = () => {
  return (
    <section className="relative w-full rounded-2xl bg-white-900 px-[24px] py-[48px] dark:bg-black-200 md:px-[30px] md:py-[72px]">
      ...
      <div className="brutalism relative mx-auto w-full max-w-[1270px] rounded-[20px] px-[18px] py-[78px] md:px-[36px] md:py-[56px] lg:px-[70px] lg:py-[82px]">
        ...
        <div className="relative z-10 flex h-full w-full flex-col items-end justify-between md:flex-row">
          ...
          >
            <Button className="brutalism bottom-0 h-[47px] w-full rounded-full bg-primary-light px-2 py-[14px] hover:bg-primary-light/90 md:h-[69px] md:w-[310px] md:max-w-[323px] md:px-3 md:py-5">
