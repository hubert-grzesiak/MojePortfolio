...
import ExperienceDescriptionCard from "@components/v2/home/ExperienceDescriptionCard";
import JobCard from "@components/v2/home/JobCard";
...
const WorkExperience = () => {
  ...
  return (
    <section className="w-full rounded-2xl bg-white-900 px-[24px] py-[48px] dark:bg-black-200 md:py-[72px]">
