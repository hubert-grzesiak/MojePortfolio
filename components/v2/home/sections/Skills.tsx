...
const Skills = () => {
  return (
    <section className="w-full rounded-2xl bg-white-900 px-6 py-[48px] dark:bg-black-200 md:px-0 md:py-[72px]">
          ...
          {skillsIcons.map((icon, index) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "brutalismv2 flex h-[52px] w-[52px] items-center justify-center rounded-full bg-white-800 dark:bg-black-300 md:h-[100px] md:w-[100px]",
                  icon.name === "React" &&
