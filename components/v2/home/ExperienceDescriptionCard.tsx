...
const ExperienceDescriptionCard: FC<ExperienceCardProps> = ({
  ...
  return (
    <TabsContent
      value={value}
      className={cn(
        "brutalism mt-0 flex min-h-[373px] w-full min-w-[345px] flex-col justify-between rounded-[10px] bg-white-800 px-[38px] pb-[38px] pt-[58px] shadow-workShadow dark:bg-black-300 md:h-[474px] md:w-full md:max-w-[422px] md:px-5 md:pb-[33px] md:pt-[34px] lg:h-full lg:max-h-[680px] lg:min-h-[590px] lg:max-w-[607px] lg:pb-9 lg:pl-11 lg:pr-[92px] lg:pt-20",
        className,
      )}
    >
      <div>
